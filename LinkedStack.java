...
public class LinkedStack<E> implements Cloneable
{
   ...
   **/ 
   ...
   /**
    * Method to determine the value of the item at nth position in the stack.
    * This method restores all popped data to maintain stack integrity.
    * @param n
    * The "index" position of the desired item in the stack
    * @return E
    * The item at the nth position in the stack
    */
   public E itemAt(int n) {
      ...
      if (this.isEmpty()) {
         ...
         E returnObj = (E) new Object();

         //put popped values in array
         for (int i = 0; i < n; i++) {
            stack.push((E) this.pop());
            if (i == n - 1) {
               returnObj = stack.peek();
            }
         }

         //put values back in stack
         for (int i = n - 1; i > -1; i--) {
            this.push(stack.pop());
         }
         return returnObj;
